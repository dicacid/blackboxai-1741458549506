...
import "../interfaces/ICryptixTicket.sol";

/**
 * @title CryptixTicket
 * @dev Implementation of the Cryptix festival ticketing system
 */
contract CryptixTicket is ICryptixTicket, ERC721, ReentrancyGuard, Ownable {
     ...
     */
    function blacklistTicket(uint256 tokenId) external override {
        require(
